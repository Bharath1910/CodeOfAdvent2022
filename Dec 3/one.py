...
for i in seperatedTestCases:
    if i != "":
        compartment1 = set(i[:len(i)//2])
        compartment2 = set(i[len(i)//2:])

        repeatingElements = compartment1.intersection(compartment2)

        for j in repeatingElements:
            score += priorityOrder.index(j) + 1
